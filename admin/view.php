...
$query = "SELECT * FROM launch_info WHERE launch_name = '" . $id . "'";
$r = mysql_query($query);
...
$allSeat_info[] = $row;
                    foreach($allSeat_info as $seat_info) {
                        ...
                        <tr bgcolor="#FFF" align="center" >
                            ...
                            <td>
                                <a href="edit.php?id=<?php echo $seat_info['catagory_id']; ?>&flag=1&launch_id=<?php echo $seat_info['launch_id'];?>">Edit</a> |
                                <a href="">Delete</a> 
                            </td>
                        </tr>
                        <?php
...
<?php 
    ...
    header("Location:http://localhost/nTicketing-master/neticketing/admin/");
}
?>