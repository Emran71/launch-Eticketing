                ...
                <table  class="table" style="box-shadow:0px 0px 16px #000000;">
                    ...
                    foreach ($allLaunchInfo as $value) {
                        ...
                        <tr bgcolor="#FFF" align="center" >
                            ...
                            <td>
                                <a href="http://localhost/neticketing/admin/view.php?id=<?php echo $value['launch_id']; ?>">View</a> |
                                <a href="http://localhost/neticketing/admin/model/delete.php?id=<?php echo $value['launch_id']; ?>">Delete</a> 
                            </td>
                        </tr>
                        <?php
                        $count = $count + 1;
